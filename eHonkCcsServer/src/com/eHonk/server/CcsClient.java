...
public class CcsClient {
	...
	private static String mApiKey = "AIzaSyCsRB87DoWepNTqJljTnIcK2jAKDYGF4Hk";
	private static String mProjectId = "253958722700";
	...
	public String getRandomMessageId(String extra) {
		return "m-" + extra + "-" + Long.toString(random.nextLong());
	}
	...
	public void sendBroadcast(Map<String, String> payload, String collapseKey,
		...
		Map map = createAttributeMap(null, null, payload, collapseKey, timeToLive,
		    delayWhileIdle);
	...
	public void handleIncomingDataMessage(CcsMessage msg) {
		if (msg.getPayload().get(Constants.PROPERTY_MESSAGE_TYPE) != null) {
			PayloadProcessor processor = ProcessorFactory.getProcessor(msg
			    .getPayload().get(Constants.PROPERTY_MESSAGE_TYPE));
	...
	/**
	 * Creates a JSON encoded ACK message for an upstream message received from an
	 * application.
	 * 
	 * @param to
	...
	public void connect() throws XMPPException {
		...
		// NOTE: Set to true to launch a window with information about packets sent
		// and received
	...
	public static void main(String[] args) {
		...
		final String projectId = mProjectId;
